...
export default function Edit ({auth,session}) {
    ...
    const img = `/storage/icon/${stack.icon}`
    ...
    const submit = (e) => {
        e.preventDefault();
        data._method = 'put'
        post(route('stack.update',stack.id));
    }
                ...
                <div className='p-4 flex justify-between items-center'>
                    ...
                    <div>
                        <Breadcrumb aria-label="Solid background breadcrumb example" className="bg-gray-50 px-5 py-3 dark:bg-gray-800">
                            ...
                            <Breadcrumb.Item>Edit Stack</Breadcrumb.Item>
                        </Breadcrumb>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        <figure className="max-w-lg">
                            <img
                                ...
                                src={selectedImage == null ?  img : URL.createObjectURL(selectedImage)}
